...
import { OrdinalsMarketplace } from '../src/contracts/ordinalsMarketplace'
...
async function main() {
    await OrdinalsMarketplace.compile()
    ...
    const instance = new OrdinalsMarketplace(
    ...
    console.log('OrdinalsMarketplace contract was successfully deployed!')
